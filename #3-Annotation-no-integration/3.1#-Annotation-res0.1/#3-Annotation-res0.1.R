...
write.csv(table(sce$cluster_id, sce$sample_id), "./dataset_so_PC20_res0.1_cluster_numbers.csv")
...
write.csv(feature_by_sample_table, "./dataset_so_PC20_res0.1_cluster_QC_feature_by_sample.csv")
...
write.csv(count_by_sample_table, "./dataset_so_PC20_res0.1_cluster_QC_count_by_sample.csv")
...
write.csv(feature_by_cluster_table, "./dataset_so_PC20_res0.1_cluster_QC_feature_by_cluster.csv")
...
write.csv(count_by_cluster_table, "./dataset_so_PC20_res0.1_cluster_QC_count_by_cluster.csv")
...
write.csv(so.markers, "./dataset_so_PC20_res0.1_cluster_genes-RNA.csv")

# Markers
#Oligo
# Oligo_marker_dot_res0.1
png("./Oligo_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Plp1","Mobp","Mog","Cnp","St18","Mag","Sox6","Cldn11", "Olig1","Lhfpl3", "Aspa", "Ermn", "Opalin"))
dev.off()
# Oligo_marker_umap_res0.1
png("./Oligo_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
...
dev.off()
# Exc-neuron
# Exc-neuron_marker_dot_res0.1
png("./Exc-neuron_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Neurod6", "Nm1", "Slc17a7", "Sv2b"))
dev.off()
# Exc-neuron_marker_umap_res0.1
png("./Exc-neuron_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
...
png("./Inh-VIP_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
...
dev.off()
#Inh-Lamp5
# Inh-Lamp5_marker_dot_res0.1
png("./Inh-Lamp5_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Erbb4","Npy","Adarb2","Lamp5","Reln","Slc32a1"))
dev.off()
# Inh-Lamp5_marker_umap_res0.1
png("./Inh-Lamp5_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
FeaturePlot(so, features = c("Erbb4","Npy","Adarb2","Lamp5","Reln","Slc32a1"), reduction = "umap", coord.fixed = 1)
dev.off()
# Exc-L5_or_6N
# Exc-L5_or_6N_marker_dot_res0.1
png("./Exc-L5_or_6N_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Tshz2","Vwc2l"))
dev.off()
# Exc-L5_or_6N_marker_umap_res0.1
png("./Exc-L5_or_6N_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
FeaturePlot(so, features = c("Tshz2","Vwc2l"), reduction = "umap", coord.fixed = 1)
dev.off()
#Exc-L6CT
# Exc-L6CT_marker_dot_res0.1
png("./Exc-L6CT_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Foxp2","Hs3st4","Zfpm2"))
dev.off()
# Exc-L6CT_marker_umap_res0.1
png("./Exc-L6CT_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
FeaturePlot(so, features = c("Foxp2","Hs3st4","Zfpm2"), reduction = "umap", coord.fixed = 1)
dev.off()
# Exc-L2&L4_or_5IT
# Exc-L2&L4_or_5IT_marker_dot_res0.1
png("./Exc-L2&L4_or_5IT_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Cux2"))
dev.off()
# Exc-L2&L4_or_5IT_marker_umap_res0.1
png("./Exc-L2&L4_or_5IT_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
FeaturePlot(so, features = c("Cux2"), reduction = "umap", coord.fixed = 1)
dev.off()
# Exc-L2_or_3IT
# Exc-L2_or_3IT_marker_dot_res0.1
png("./Exc-L2_or_3IT_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Ndst4","Brinp1","Abi3bp"))
dev.off()
# Exc-L2_or_3IT_marker_umap_res0.1
png("./Exc-L2_or_3IT_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
FeaturePlot(so, features = c("Ndst4","Brinp1","Abi3bp"), reduction = "umap", coord.fixed = 1)
dev.off()
# Exc-L6b(not found)
# Exc-L6b_marker_dot_res0.1
png("./Exc-L6b_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Lcp1"))
dev.off()
# Exc-L6b_marker_umap_res0.1
png("./Exc-L6b_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
FeaturePlot(so, features = c("Lcp1"), reduction = "umap", coord.fixed = 1)
dev.off()
# Exc-Car3
# Exc-Car3_marker_dot_res0.1
png("./Exc-Car3_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Col11a1"))
dev.off()
# Exc-Car3_marker_umap_res0.1
png("./Exc-Car3_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
FeaturePlot(so, features = c("Col11a1"), reduction = "umap", coord.fixed = 1)
dev.off()
# Macrophage
# Macrophage_marker_dot_res0.1
png("./Macrophage_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Dab2", "Vcan", "Fcn1", "Crip1"))
dev.off()
# Macrophage_marker_umap_res0.1
png("./Macrophage_marker_umap_res0.1.png",
    width = 1200,
    height = 600)
FeaturePlot(so, features = c("Dab2", "Vcan", "Fcn1", "Crip1"), reduction = "umap", coord.fixed = 1)
dev.off()
# T cell
# T_cell_marker_dot_res0.1
png("./T_cell_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Cd44","Nrp1"))
dev.off()
# T_cell_marker_umap_res0.1
png("./T_cell_marker_umap_res0.1.png",
    width = 1200,
    height = 600)
...
# Glial cell
# Glial cell_marker_dot_res0.1
png("./Glial cell_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Egfr","Hes1","Plp1","Sox10","Tnc","Mki67"))
dev.off()
# Glial cell_marker_umap_res0.1
png("./Glial cell_marker_umap_res0.1.png",
    width = 1200,
    height = 600)
...
so.renamed <- RenameIdents(so,
                           `0` = "Exc-neuron1", `1` = "Exc-L2&L4/5IT", `2` = "Astro1", `3` = "Oligo1",
                           `4` = "Micro", `5` = "Exc-L6CT", `6` = "Inh-PV&SST", `7` = "Exc-neuron2", 
                           `8` = "Inh-VIP&Lamp5", `9` = "OPC1", `10` = "Interneuron", `11` = "Exc-neuron3",
                           `12` = "Astro(Dab2+,Slc1a3+)", `13` = "Glial cell(Egfr+)", `14` = "Endo(Igfbp7+)", `15` = "Endo",
                           `16` = "Astro2", `17` = "Exc-Car3", `18` = "Oligo2", `19` = "Astro3")
...
saveRDS(so.renamed, file.path("./", "so.renamed_res0.1.rds"))
