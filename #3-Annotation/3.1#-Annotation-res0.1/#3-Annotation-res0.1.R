...
so <- readRDS(file.path("../../#2-DR/", "seu_18PC.rds"))
...
write.csv(table(sce$cluster_id, sce$sample_id), "./dataset_so_PC18_res0.1_cluster_numbers.csv")
...
write.csv(feature_by_sample_table, "./dataset_so_PC18_res0.1_cluster_QC_feature_by_sample.csv")
...
write.csv(count_by_sample_table, "./dataset_so_PC18_res0.1_cluster_QC_count_by_sample.csv")
...
write.csv(feature_by_cluster_table, "./dataset_so_PC18_res0.1_cluster_QC_feature_by_cluster.csv")
...
write.csv(count_by_cluster_table, "./dataset_so_PC18_res0.1_cluster_QC_count_by_cluster.csv")
...
write.csv(so.markers, "./dataset_so_PC18_res0.1_cluster_genes-RNA.csv")
...
so.renamed <- RenameIdents(so,
                           ...
                           `4` = "Micro", `5` = "Exc-L6CT", `6` = "Exc-neuron2", `7` = "Inh-PV&SST", 
                           `8` = "Interneuron", `9` = "Inh-VIP&Lamp5", `10` = "OPC1", `11` = "Exc-L5/6N",
                           `12` = "Exc-neuron3", `13` = "Astro(Slc1a3+,Dab2+)", `14` = "Glial cell(Egfr+)", `15` = "Oligo2",
                           `16` = "Endo(Igfbp7+)", `17` = "Endo", `18` = "Exc-Car3", `19` = "Astro2",
                           `20` = "Astro3")
