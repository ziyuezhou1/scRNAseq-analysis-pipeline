...
#   N3_VS_N2_re[[i]] <- FindMarkers(object = seurat.renamed,
#                                   group.by = "group_id",
#                                   ident.1 = "SD6h ZT0-ZT6",
#                                   ident.2 = "ZT18",
#                                   subset.ident = i,
...
# if (!file.exists("results/N3_vs_N2_re")) dir.create("results/N3_vs_N2_re")
# for (i in seq.int(1,8,1)){
#   write.csv(N3_VS_N2_re[[i]], file = paste0(".\\results\\N3_vs_N2_re\\N3_vs_N2_re_", to_name_csv[[i]], ".csv"))
# }
# df_re <- as.data.frame(do.call(rbind, N3_VS_N2_re))
...
#   theme_classic() +
#   theme(text = element_text(size = 20), plot.title = element_text(hjust = 0.5)) +
#   labs(title = "DEG N3 vs. N2 renamed", x = "Clusters", y = "log2FC(N3/N2)")
# dev.off()
# 
