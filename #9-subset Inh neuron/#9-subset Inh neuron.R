...
so_inh <- subset(x = so.renamed, idents = c("Inh-PV&SST","Inh-VIP&Lamp5","Interneuron"), invert = FALSE)
...
so_inh <- NormalizeData(so_inh, verbose = FALSE)
so_inh <- FindVariableFeatures(so_inh, nfeatures = 2000,
                               selection.method = "vst",
                               do.plot = FALSE,
                               verbose = FALSE)
so_inh <- ScaleData(so_inh, verbose = FALSE)
...
so_inh <- RunTSNE(so_inh, reduction = "pca", dims = seq_len(11),
                    seed.use = 1, do.fast = TRUE, verbose = FALSE)
so_inh <- RunUMAP(so_inh, reduction = "pca", dims = seq_len(11),
                    seed.use = 1, verbose = FALSE)

#CLUSTERING
so_inh <- FindNeighbors(so_inh, reduction = "pca", dims = seq_len(11), verbose = FALSE)
...
#Save SeuratObject
saveRDS(so_inh, file.path("so_inh_11PC.rds"))
...
so <- readRDS(file.path("./", "so_inh_11PC.rds"))
...
so <- SetIdent(so, value = "RNA_snn_res.0.1")
so@meta.data$cluster_id <- Idents(so)
sce$cluster_id <- Idents(so)
(n_cells <- table(sce$cluster_id, sce$sample_id))
write.csv(table(sce$cluster_id, sce$sample_id), "./dataset_so_PC11_res0.1_cluster_numbers.csv")
...
write.csv(feature_by_sample_table, "./dataset_so_PC11_res0.1_cluster_QC_feature_by_sample.csv")
...
write.csv(count_by_sample_table, "./dataset_so_PC11_res0.1_cluster_QC_count_by_sample.csv")
...
write.csv(feature_by_cluster_table, "./dataset_so_PC11_res0.1_cluster_QC_feature_by_cluster.csv")
...
write.csv(count_by_cluster_table, "./dataset_so_PC11_res0.1_cluster_QC_count_by_cluster.csv")
...
png("./Dimplot-clusters.png",
    width = 1200,
    height = 1200)
DimPlot(so, reduction = "umap", pt.size = 0.001, label = TRUE, label.size = 40) + theme(aspect.ratio = 1) + scale_color_manual(values = usecol("pal_unikn_pair", 40))
dev.off()
...
write.csv(so.markers, "./dataset_so_PC11_res0.1_cluster_genes-RNA.csv")

# Markers
# Inh-neuron
# from Adarb2 or Lhx6
# Adarb2_Lhx6_marker_dot_res0.1
png("./Adarb2_Lhx6_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Adarb2", "Lhx6"))
dev.off()
# Adarb2_Lhx6_marker_umap_res0.1
png("./Adarb2_Lhx6_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
FeaturePlot(so, features = c("Adarb2", "Lhx6"), reduction = "umap", coord.fixed = 1)
dev.off()
# Adarb2_subtype_marker_dot_res0.1
png("./Adarb2_subtype_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Lamp5", "Pax6", "Vip", "Pbx3"))
dev.off()
# Adarb2_subtype_marker_umap_res0.1
png("./Adarb2_subtype_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
FeaturePlot(so, features = c("Lamp5", "Pax6", "Vip", "Pbx3"), reduction = "umap", coord.fixed = 1)
dev.off()
# Lamp5_subtype_marker_dot_res0.1
png("./Lamp5_subtype_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Nmbr", "Lcp2", "Dbp"))
dev.off()
# Lamp5_subtype_marker_umap_res0.1
png("./Lamp5_subtype_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
FeaturePlot(so, features = c("Nmbr", "Lcp2", "Dbp"), reduction = "umap", coord.fixed = 1)
dev.off()
# Vip_subtype_marker_dot_res0.1
png("./Vip_subtype_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Syt6", "Tspan12", "Chrna6", "Adamtsl1", "Penk","Qpct",
                         "Pcdh20", "Serpinf1", "Tyr", "Chrm2", "Cbln1", "Ccdc184", "Ggh",
                         "Lbh", "Spag17", "Oprm1"))
dev.off()
# Vip_subtype_marker_umap_res0.1
png("./Vip_subtype_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
FeaturePlot(so, features = c("Syt6", "Tspan12", "Chrna6", "Adamtsl1", "Penk","Qpct",
                             "Pcdh20", "Serpinf1", "Tyr", "Chrm2", "Cbln1", "Ccdc184", "Ggh",
                             "Lbh", "Spag17", "Oprm1"), reduction = "umap", coord.fixed = 1)
dev.off()
# Pax6_subtype_marker_dot_res0.1
png("./Pax6_subtype_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Cdh12", "Tnfaip8l3"))
dev.off()
# Pax6_subtype_marker_umap_res0.1
png("./Pax6_subtype_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
FeaturePlot(so, features = c("Cdh12", "Tnfaip8l3"), reduction = "umap", coord.fixed = 1)
dev.off()
# Lhx6_subtype_marker_dot_res0.1
png("./Lhx6_subtype_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Sst", "Pvalb"))
dev.off()
# Lhx6_subtype_marker_umap_res0.1
png("./Lhx6_subtype_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
FeaturePlot(so, features = c("Sst", "Pvalb"), reduction = "umap", coord.fixed = 1)
dev.off()
# Sst_subtype_marker_dot_res0.1
png("./Sst_subtype_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Npy", "Hpgd", "B3gat2", "Klhdc8a", 
                         "Gxylt2", "Stk32a", "Calb1", "Adgrg6", "Frzb",
                         "Th"))
dev.off()
# Sst_subtype_marker_umap_res0.1
png("./Sst_subtype_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
FeaturePlot(so, features = c("Npy", "Hpgd", "B3gat2", "Klhdc8a", 
                             "Gxylt2", "Stk32a", "Calb1", "Adgrg6", "Frzb",
                             "Th"), reduction = "umap", coord.fixed = 1)
dev.off()
# PV_subtype_marker_dot_res0.1
png("./PV_subtype_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Lgr5", "Wfdc2", "Sulf1", "Scube3"))
dev.off()
# PV_subtype_marker_umap_res0.1
png("./PV_subtype_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
FeaturePlot(so, features = c("Lgr5", "Wfdc2", "Sulf1", "Scube3"), reduction = "umap", coord.fixed = 1)
dev.off()
# Inh-neuron_marker_dot_res0.1
png("./Inh-neuron_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Gad2", "Gad1"))
dev.off()
# Inh-neuron_marker_umap_res0.1
png("./Inh-neuron_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
FeaturePlot(so, features = c("Gad2", "Gad1"), reduction = "umap", coord.fixed = 1)
dev.off()
# Interneuron
# Interneuron_marker_dot_res0.1
png("./Interneuron_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Gad1", "Gad2", "Slc32a1"))
dev.off()
# Interneuron_marker_umap_res0.1
png("./Interneuron_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
FeaturePlot(so, features = c("Gad1", "Gad2", "Slc32a1"), reduction = "umap", coord.fixed = 1)
dev.off()
# Inh-PV
# Inh-PV_marker_dot_res0.1
png("./Inh-PV_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Erbb4","Pvalb"))
dev.off()
# Inh-PV_marker_umap_res0.1
png("./Inh-PV_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
FeaturePlot(so, features = c("Erbb4", "Pvalb"), reduction = "umap", coord.fixed = 1)
dev.off()
# Inh-VIP
# Inh-VIP_marker_dot_res0.1
png("./Inh-VIP_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Gad2", "Gad1", "Npy", "Vip", "Adarb2"))
dev.off()
# Inh-VIP_marker_umap_res0.1
...
dev.off()
#Inh-SST
# Inh-SST_marker_dot_res0.1
png("./Inh-SST_marker_dot_res0.1.png",
    width = 1200,
    height = 600)
DotPlot(so, features = c("Sst"))
dev.off()
# Inh-SST_marker_umap_res0.1
png("./Inh-SST_marker_umap_res0.1.png",
    width = 1200,
    height = 1200)
...
so.renamed <- RenameIdents(so,
                           `0` = "Inh-PV", `1` = "Inh-SST(Calb1+)", `2` = "Inh-VIP(Penk+)", `3` = "Inh-Lamp5(Dbp+)",
                           `4` = "Inh-Adarb2+Lhx6-Pbx3+", `5` = "Inh-Erbb4+", `6` = "Inh-PAX6", `7` = "Inh-SST(Npy+Adgrg6+)" 
                        )
...
saveRDS(so.renamed, file.path("./", "so_inh.renamed_res0.1.rds"))
